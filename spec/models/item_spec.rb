    ...
    context '出品情報登録ができるとき' do
      ...
      context '出品情報登録ができないとき' do
        ...
        it 'カテゴリーの情報が空だと登録できない' do
          ...
          @item.valid?
          expect(@item.errors.full_messages).to include("Category can't be blank", "Category 入力してください")
        end
        ...
        it '商品の状態の情報が空だと登録できない' do
          ...
          @item.valid?
          expect(@item.errors.full_messages).to include("Condition can't be blank", "Condition 入力してください")
        end
        it '配送料の負担の情報が「---」だと登録できない' do
          @item.delivery_charge_id = 1
          @item.valid?
          expect(@item.errors.full_messages).to include("Delivery charge 入力してください")
        end
        it '配送料の負担の情報が空だと登録できない' do
          @item.delivery_charge_id = nil
          @item.valid?
          expect(@item.errors.full_messages).to include("Delivery charge can't be blank", "Delivery charge 入力してください")
        end
        ...
        it '発送元の地域の情報が空だと登録できない' do
          ...
          @item.valid?
          expect(@item.errors.full_messages).to include("Prefecture can't be blank", "Prefecture 入力してください")
        end
        it '発送までの日数の情報が「---」だと登録できない' do
          @item.delivery_day_id = 1
          @item.valid?
          expect(@item.errors.full_messages).to include("Delivery day 入力してください")
        end
        it '発送までの日数の情報が空だと登録できない' do
          @item.delivery_day_id = nil
          @item.valid?
          expect(@item.errors.full_messages).to include("Delivery day can't be blank", "Delivery day 入力してください")
        end
        it '価格が空だと登録できない' do
          @item.price = nil
          @item.valid?
